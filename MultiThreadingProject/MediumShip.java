...
public class MediumShip extends  Ship{
    public MediumShip(String name, String HomePort, String TransportOrigin, String destination, int MaxWeightCapacity, int MaxNumberOfContainers, int MaxNumberOfHeavyContainers, int MaxNumberOfContainersWithElectricity, int MaxNumberOfToxicContainersAndExplosive) {
