...
public class SmallShip extends Ship{
    public SmallShip(String name, String HomePort, String TransportOrigin, String destination, int MaxWeightCapacity, int MaxNumberOfContainers, int MaxNumberOfHeavyContainers, int MaxNumberOfContainersWithElectricity, int MaxNumberOfToxicContainersAndExplosive) {
