...
public class ToxicShip extends Ship{

    public ToxicShip(String name, String HomePort, String TransportOrigin, String destination, int MaxWeightCapacity, int MaxNumberOfContainers, int MaxNumberOfHeavyContainers, int MaxNumberOfContainersWithElectricity, int MaxNumberOfToxicContainersAndExplosive) {
